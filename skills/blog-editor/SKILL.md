...
- **Em dashes**: Flag all uses of `—`. Replace with a colon, comma, semicolon, parentheses, or a restructured sentence depending on context. Em dashes are a known AI writing signal and should be avoided entirely.
