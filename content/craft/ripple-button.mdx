...
Click the button below. Then click it again somewhere else. Notice that the wave always starts exactly where you pressed.

<RippleButtonDemo />

## Why Click Position Matters

A ripple that always originates from center feels _wrong_. Your brain expects the wave to emanate from where you actually pressed. The origin of an animation should match the origin of the interaction.
