...
Once you can answer that question, you can map the result to any CSS property: blur, scale, opacity, hue, rotation. The image above uses blur and a vertical offset.
...
> The core ideas in this post — distance math, normalization, and throttling bounding rect reads — draw heavily from Josh Comeau's [Whimsical Animations](https://courses.joshwcomeau.com/wham) course. If this clicked for you, that course goes much deeper.
